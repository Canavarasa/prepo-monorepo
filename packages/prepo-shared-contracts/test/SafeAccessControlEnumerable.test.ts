...
describe('SafeAccessControlEnumerable', () => {
  ...
  describe('# acceptRoleAdmin', () => {
    ...
    it('reverts if not role admin and not role admin nominee', async () => {
      ...
      await expect(safeAccessControlEnumerable.connect(user1).acceptRoleAdmin(roleB)).revertedWith(
    ...
    it('reverts if not role admin nominee but is role admin', async () => {
      ...
      await expect(safeAccessControlEnumerable.connect(owner).acceptRoleAdmin(roleB)).revertedWith(
