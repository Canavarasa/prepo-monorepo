...
export class UniswapV3GraphStore extends GraphStore<RootStore, SupportedContracts> {
  ...
  constructor(root: RootStore) {
    ...
    makeObservable(this, {
      poolsQuery: observable,
      poolsDayDatas: observable,
  ...
  historicalDailyData(
    ...
    const query = this.continuousQuery<PoolsDayDatas, unknown>(
      poolsDayDatasQueryString,
      {
        longPoolId,
        shortPoolId,
  ...
  historicalHourlyData(
    ...
    const query = this.continuousQuery<PoolsHourDatas, unknown>(
      poolsHourDatasQueryString,
      {
        longPoolId,
        shortPoolId,
