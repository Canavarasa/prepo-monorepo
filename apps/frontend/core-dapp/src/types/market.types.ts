...
export type SupportedMarketID = 'arbitrum' | 'zksync' | 'starknet'

export type MarketType = 'preICO' | 'preIPO'

export type MarketVersion = 'v1.0' | 'v1.1'
...
export type SeparatedMarketHistoryData = {
  long: MarketHistoryData[]
  short: MarketHistoryData[]
}

/**
 * @deprecated just use `number` directly instead
 */
...
export type PoolsData = {
  longTokenPool: PoolData | null
  shortTokenPool: PoolData | null
}
