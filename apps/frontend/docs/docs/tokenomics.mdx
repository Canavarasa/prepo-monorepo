...
_❗ If you're looking for details around the token distribution, or general token or presale questions, see the **[FAQ](/faq#token)** instead!_
...
Since prePO is a decentralized protocol, PPO stakers are responsible for governance.

PPO Power can be used to submit and vote on proposals, including for new markets, market resolution, fee adjustments, liquidity redirection, representative council members, and how treasury funds should be used.
