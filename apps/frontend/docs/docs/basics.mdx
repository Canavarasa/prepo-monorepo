...
_All investors_ miss out on opportunities due to there being limited places on a cap table.
...
prePO will be governed by the prePO Decentralized Autonomous Organization (DAO), with decisions driven by a global community of [PPO token stakers ('pregens')](/concepts/actors#pregens).
